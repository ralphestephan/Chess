...
class User(db.Model):
    ...
    password = db.Column(db.String(200), nullable=False)  # Password stored securely
...
class Game(db.Model):
    ...
    winner = db.Column(db.Integer, db.ForeignKey('user.id'), nullable=True)  # Winner of the game
